...
export const About: React.FC = () => {
  return (
    <>
      ...
      <Paragraph alignment="left">I&apos;m a <b>frontend software engineer</b> specializing in<br /> Mobile Development with great project<br /> management abilities.</Paragraph>
